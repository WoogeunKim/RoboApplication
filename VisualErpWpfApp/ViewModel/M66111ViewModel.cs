...
{
    public sealed class M66111ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public async void Refresh()
        {
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("m66111", new StringContent(JsonConvert.SerializeObject(_param), System.Text.Encoding.UTF8, "application/json")))
                {
