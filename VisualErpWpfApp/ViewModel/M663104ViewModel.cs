...
{
    public sealed class M663104ViewModel : ViewModelBase, INotifyPropertyChanged {


        private string _title = "칭량 지시 계획";
       ...
       // private IList<CodeDao> useList;
        ...
        private M663104MasterDialog masterDialog;


        public M663104ViewModel() 
        {
        ...
        public void NewContact()
        {
            ...
            masterDialog = new M663104MasterDialog(new ManVo() { CHNL_CD = SystemProperties.USER_VO.CHNL_CD });
        ...
        public void EditMasterContact()
        {
            ...
            masterDialog = new M663104MasterDialog(SelectedMenuItem);
            ...
            if (isDialog)
            {
                ...
                Refresh( masterDialog.updateDao.LOT_NO);
