...
namespace AquilaErpWpfApp3.View.S.Dialog
{
    ...
    /// </summary>
    public partial class S141BarPrintDialog : DXWindow
    {
        ...
        public S141BarPrintDialog(SystemCodeVo _item)
        {
            InitializeComponent();
            //
        ...
        public async void EXCEL_REPORT(SystemCodeVo _item)
        {
            try
            {
                string _RPT_CD = "BAR100";
                if (_item.ITM_GRP_CLSS_CD.Equals("M"))
                {
                    _RPT_CD = "BAR100";
                }
                else if (_item.ITM_GRP_CLSS_CD.Equals("B"))
                {
                    _RPT_CD = "BAR200";
                }

                //
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s1412/mst", new StringContent(JsonConvert.SerializeObject(new SystemCodeVo() { CHNL_CD = SystemProperties.USER_VO.CHNL_CD, RPT_CD = _RPT_CD }), System.Text.Encoding.UTF8, "application/json")))
                {
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        ////MIX_WEIH_VAL
                        //worksheet.Cells["R6"].Value = _items[0].MIX_WEIH_VAL * 1000;
                        ...
                        ////바코드
                        //worksheet.Pictures.AddPicture(barCode.BarCodeImage, worksheet.Cells["AC50"]);
                    }
                }
        ...
        private void biFileQuickPrint_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            this.spreadsheetControl1.Document.SaveDocument(AppDomain.CurrentDomain.BaseDirectory + "s141BarPrint");
            ...
            //worksheet.ActiveView.s
          //worksheet.PrintOptions.cu = new System.Drawing.Size(800,1000);
          ...
          WorksheetPrintOptions printOptions = worksheet.PrintOptions;
            ...
            worksheet.PrintOptions.AutoPageBreaks = true;
            //worksheet.PrintOptions.page
            ...
            using (LegacyPrintableComponentLink link = new LegacyPrintableComponentLink(this.spreadsheetControl1.Document, _title))
            {
                ...
                //link.CustomPaperSize = new System.Drawing.Size(800,1000);
