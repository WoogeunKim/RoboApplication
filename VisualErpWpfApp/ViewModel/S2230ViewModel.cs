...
{
    public sealed class S2230ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string title = "출하현황";
        ...
        public async void Refresh()
        {
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("S2230/mst", new StringContent(JsonConvert.SerializeObject(_param), System.Text.Encoding.UTF8, "application/json")))
                {
