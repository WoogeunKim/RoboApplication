...
{
    public sealed class P4420ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string _title = "발주 등록 관리(레진)";
        ...
        private P4420MasterDialog masterDialog;
        private P4420Detail_1Dialog detailDialog_1;
        private P4420Detail_2Dialog detailDialog_2;

        private P4420Detail_3Dialog detailDialog_3;
        ...
        {
            masterDialog = new P4420MasterDialog(new PurVo() { AREA_CD = M_SL_AREA_NM.CLSS_CD, AREA_NM = M_SL_AREA_NM.CLSS_DESC, PUR_DT = System.DateTime.Now.ToString("yyyy-MM-dd"), PUR_CLZ_FLG = "N", PUR_EMPE_ID = SystemProperties.USER_VO.USR_ID });
        ...
        public void EditContact()
        {
            ...
            masterDialog = new P4420MasterDialog(SelectedMstItem);
        ...
        {
            detailDialog_3 = new P4420Detail_3Dialog(new PurVo() { });
        ...
        public void NewDtlContact()
        {
            ...
            detailDialog_1 = new P4420Detail_1Dialog(new PurVo() { PUR_ORD_NO = SelectedMstItem.PUR_ORD_NO, CHNL_CD = SystemProperties.USER_VO.CHNL_CD, CRE_USR_ID = SystemProperties.USER_VO.USR_ID, UPD_USR_ID = SystemProperties.USER_VO.USR_ID });
        ...
        public void EditDtlContact()
        {
            ...
            detailDialog_2 = new P4420Detail_2Dialog(new PurVo() { PUR_ORD_NO = SelectedMstItem.PUR_ORD_NO, CHNL_CD = SystemProperties.USER_VO.CHNL_CD, CRE_USR_ID = SystemProperties.USER_VO.USR_ID, UPD_USR_ID = SystemProperties.USER_VO.USR_ID });
