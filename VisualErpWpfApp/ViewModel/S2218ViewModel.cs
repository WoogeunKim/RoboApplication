...
{
    public sealed class S2218ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string title = "반품현황";
        ...
        public async void Refresh()
        {
            try
            {
                ...
                _param.CRE_DT = System.DateTime.Now;


                ////
                //SelectMstList = saleOrderClient.S2221SelectMstList(_param);
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("S2218/mst", new StringContent(JsonConvert.SerializeObject(_param), System.Text.Encoding.UTF8, "application/json")))
                {
