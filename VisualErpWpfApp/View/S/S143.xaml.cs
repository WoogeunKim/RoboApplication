...
{
    public partial class S143 : UserControl
    {
        ...
        public S143()
        {
            ...
            //{
            //    WinUIMessageBox.Show(eLog.Message, "[" + SystemProperties.PROGRAM_TITLE + "]거래처 관리", MessageBoxButton.OK, MessageBoxImage.Error);
            //}
            ////
        ...
        private void Hyperlink_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                SystemCodeVo dao = (SystemCodeVo)DetailView.Content;
                 if (dao != null)
                 {
                     System.Diagnostics.Process.Start( dao.HMPG_ADDR);
                 }
            }
            catch (Exception eLog)
            {
        ...
        //    {
        //        this.ConfigViewPage1Edit_Master.ShowLoadingPanel = false;
        //        WinUIMessageBox.Show(eLog.Message, "[에러]거래처 코드", MessageBoxButton.OK, MessageBoxImage.Error);
        //        this.txt_Master_Search.SelectAll();
        //        this.txt_Master_Search.Focus();
        //        return;
        //    }
    ...
    //    }
        ...
        //    {
        //        this.ConfigViewPage1Edit_Master.ShowLoadingPanel = false;
        //        WinUIMessageBox.Show(eLog.Message, "[에러]거래처 관리", MessageBoxButton.OK, MessageBoxImage.Error);
