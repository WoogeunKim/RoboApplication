...
{
    public sealed class S22111ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private S22111NextMonthDialog masterNextMonthDialog;
        private S22111AddDialog masterAddDialog;
        ...
        public async void SelectMstDetail()
        {
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s22111/dtl", new StringContent(JsonConvert.SerializeObject(SelectedMstItem), System.Text.Encoding.UTF8, "application/json")))
                {
                    if (response.IsSuccessStatusCode)
                    {
        ...
        {
            masterDialog = new S22111MasterDialog(new SaleVo() { SL_AREA_NM = SystemProperties.USER_VO.EMPE_PLC_CD });
            ...
            try
            {
                ...
                //{
                    ...
                    if (result == MessageBoxResult.Yes)
                    {
                        ...
                        using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s22111/mst/d", new StringContent(JsonConvert.SerializeObject(SelectedMstItem), System.Text.Encoding.UTF8, "application/json")))
                        {
                            if (response.IsSuccessStatusCode)
                            {
                                int _Num = 0;
        ...
        public async void NextMonthContact()
        {
            ...
            masterNextMonthDialog = new S22111NextMonthDialog(SelectedMstItem);
            ...
            if (isDialog)
            {
                try
                {
                    ...
                    using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s22111/mst/u", new StringContent(JsonConvert.SerializeObject(SelectedMstItem), System.Text.Encoding.UTF8, "application/json")))
                    {
                        int _Num = 0; 
                        if (response.IsSuccessStatusCode)
                        {
        ...
        public async void AddContact()
        {
            ...
            masterAddDialog = new S22111AddDialog(SelectedMstItem);
