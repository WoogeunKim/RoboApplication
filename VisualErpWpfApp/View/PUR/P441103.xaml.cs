...
{
    public partial class P441103 : UserControl
    {
        ...
        public P441103()
        {
            DataContext = new P441103ViewModel();
            //
            InitializeComponent();
                    ...
                    if (e.IsValid)
                    {
                        ...
                        if (!masterDomain.PUR_ITM_RMK.Equals((e.Value == null ? "" : e.Value.ToString())))
                        {
                            try
                            {
                                ...
                                int _Num = 0;
                                string resultMsg = "";
                                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("p441103/dtl/u", new StringContent(JsonConvert.SerializeObject(masterDomain), System.Text.Encoding.UTF8, "application/json")))
                                {
