    ...
    public partial class I66110DetailPurDialog : DXWindow
    {
        ...
        private async void searchItem()
        {
            try
            {
                ...
                //    return;
                //}
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("i66110/pur", new StringContent(JsonConvert.SerializeObject(vo), System.Text.Encoding.UTF8, "application/json")))
                {
