...
{
    public sealed class P4412ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private P4412Detail_2Dialog detailDialog_2;
        ...
        public async void PrintContact()
        {
            ...
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s143/dtl", new StringContent(JsonConvert.SerializeObject(new SystemCodeVo() { DELT_FLG = "N", CO_NO = "AL01", AREA_CD = SystemProperties.USER_VO.EMPE_PLC_NM, CHNL_CD = SystemProperties.USER_VO.CHNL_CD }), System.Text.Encoding.UTF8, "application/json")))
                {
                    if (response.IsSuccessStatusCode)
                    {
                        coNm = JsonConvert.DeserializeObject<SystemCodeVo>(await response.Content.ReadAsStringAsync());
                ...
                P4412Report report = new P4412Report(SelectDtlList);
                report.Margins.Top = 30;
                report.Margins.Bottom = 10;
                report.Margins.Left = 120;
                report.Margins.Right = 10;
    ...
    [Command]
        ...
        public void EditDtlContact()
        {
            ...
            detailDialog_2 = new P4412Detail_2Dialog(new PurVo() { PUR_ORD_NO = SelectedMstItem.PUR_ORD_NO, CHNL_CD = SystemProperties.USER_VO.CHNL_CD, CRE_USR_ID = SystemProperties.USER_VO.USR_ID, UPD_USR_ID = SystemProperties.USER_VO.USR_ID });
