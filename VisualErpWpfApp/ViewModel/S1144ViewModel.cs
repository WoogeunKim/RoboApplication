...
{
    public sealed class S1144ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string title = "창고위치관리";
       ...
       public async void Refresh(string _ITM_CD = null)
        {
            ...
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s1144/mst", new StringContent(JsonConvert.SerializeObject(_param), System.Text.Encoding.UTF8, "application/json")))
                {
