    ...
    public partial class S1144 : UserControl
    {
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            if (selVo != null)
            {
                ...
                sb.Append("<dxe:TextEdit Text=\"" + "[마감년월 : " + selVo.FM_DT + ", 거래처 : " + "" + "] " + "\" FontWeight=\"Bold\"  FontSize=\"10\"  />");
                ...
                using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
                {
                  //  prtLink.PageHeaderTemplate = templateHeader;
                    ...
                    prtLink.DocumentName = "창고위치관리 - Print";
                    ...
                    prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "창고위치관리");
                }
            }
        }
