...
{
    public sealed class T6325ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string _title = "제품검사";

        private T6325MasterDialog masterDialog;
        ...
        public async void EditContact()
        {
            ...
            masterDialog = new T6325MasterDialog(SelectedMstItem);
