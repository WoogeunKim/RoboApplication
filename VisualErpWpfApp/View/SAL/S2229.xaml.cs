...
namespace AquilaErpWpfApp3.View.SAL
{
    ...
    /// </summary>
    public partial class S2229 : UserControl
    {
        ...
        public S2229()
        {
            DataContext = new S2229ViewModel();
            InitializeComponent();
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "매출-일자별원장 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "매출-일자별원장");
            }
        }
        ...
        //    {
        //        this.ViewGridMst.ShowLoadingPanel = false;
        //        WinUIMessageBox.Show(eLog.Message, "[에러]매출처원장", MessageBoxButton.OK, MessageBoxImage.Error);
