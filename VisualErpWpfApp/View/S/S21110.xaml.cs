...
{
    public partial class S21110 : UserControl
    {
        //private CustomerDialog customersDialog;

        public S21110()
        {
            DataContext = new S21110ViewModel();
            //
            InitializeComponent();
        ...
        //      {
        //          this.ViewGridMst.ShowLoadingPanel = false;
        //          WinUIMessageBox.Show(eLog.Message, "[에러]매입 단가 관리", MessageBoxButton.OK, MessageBoxImage.Error);
