...
namespace AquilaErpWpfApp3.View.M.Dialog
{
    ...
    /// </summary>
    public partial class M6683MasterDialog : DXWindow
    {
        ...
        private string _title = "설비도면이력관리";
        ...
        public string _PROD_EQ_NO;
        //private int? _ITM_DWG_SEQ;

        public M6683MasterDialog(ManVo Dao)
        {
            InitializeComponent();
            ...
            ManVo copyDao = new ManVo()
            {
                ...
                EQ_NM = Dao.EQ_NM,
                ITM_EQ_SEQ = Dao.ITM_EQ_SEQ,
                EQ_FILE = Dao.EQ_FILE,
                EQ_FILE_NM = Dao.EQ_FILE_NM,
                EQ_RMK = Dao.EQ_RMK,
            ...
            //{
                ...
                this._PROD_EQ_NO = Dao.PROD_EQ_NO;
                //this._ITM_DWG_SEQ = Dao.ITM_DWG_SEQ;
        ...
        void btn_file_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
                ...
                {
                    WinUIMessageBox.Show("[파일 크기] 3MB를 초과 하였습니다", "[유효검사]설비도면이력관리", MessageBoxButton.OK, MessageBoxImage.Warning);
                    this.text_EQ_FILE_NM.Text = "";
                    this.fileByte = new byte[0];
                    return;
                }
        ...
        private async void OKButton_Click(object sender, RoutedEventArgs e)
        {
            if (ValueCheckd())
            {
                ...
                if (isEdit == false)
                {
                    ...
                    using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("m6683/i", new StringContent(JsonConvert.SerializeObject(this.updateDao), System.Text.Encoding.UTF8, "application/json")))
                    {
        ...
        public Boolean ValueCheckd()
        {
            ...
            {
                WinUIMessageBox.Show("[설비도면명] 입력 값이 맞지 않습니다.", "[유효검사]설비도면이력관리", MessageBoxButton.OK, MessageBoxImage.Warning);
        ...
        private ManVo getDomain()
        {
            ...
            if (fileByte == null)
            {
                Dao.EQ_FILE = new byte[0];
            }
            else
            {
                Dao.EQ_FILE = this.fileByte;
            }
