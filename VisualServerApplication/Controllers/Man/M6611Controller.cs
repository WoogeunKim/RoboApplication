...
{
    [RoutePrefix("m6611")]
    public class M6611Controller : ApiController
    {
        #region MyRegion
        //// GET api/<controller>
        ...
        {
            return Ok<IEnumerable<ManVo>>(Properties.EntityMapper.QueryForList<ManVo>("M6611SelectMaster", vo));
        }
        ...
        public async Task<IHttpActionResult> GetMstInsert([FromBody]ManVo vo)
        {
            try
            {
                return Ok<int>(Properties.EntityMapper.Insert("M6611InsertMaster", vo) == null ? 1 : 0);
            }
        ...
        public async Task<IHttpActionResult> GetMstDelete([FromBody]ManVo vo)
        {
            try
            {
                return Ok<int>(Properties.EntityMapper.Delete("M6611DeleteMaster", vo));
            }
            catch (System.Exception eLog)
            {
                return Ok<string>(eLog.Message);
