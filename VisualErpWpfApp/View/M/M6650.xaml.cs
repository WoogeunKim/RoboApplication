...
namespace AquilaErpWpfApp3.View.M
{
    ...
    /// </summary>
    public partial class M6650 : UserControl
    {
        ...
        public M6650()
        {
            DataContext = new M6650ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "수주별 입고 현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "수주별 입고 현황");
            }
        }
