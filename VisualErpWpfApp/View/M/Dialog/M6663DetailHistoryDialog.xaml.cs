...
namespace AquilaErpWpfApp3.View.M.Dialog
{
    ...
    /// </summary>
    public partial class M6663DetailHistoryDialog : DXWindow
    {
        ...
        public M6663DetailHistoryDialog(SystemCodeVo Dao)
        {
            InitializeComponent();
        ...
        {
            using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("s1144/his/mold", new StringContent(JsonConvert.SerializeObject(new SystemCodeVo() { AREA_CD = orgDao.AREA_CD, FM_DT = Convert.ToDateTime(this.txt_stDate.Text).ToString("yyyy-MM-dd"), TO_DT = Convert.ToDateTime(this.txt_enDate.Text).ToString("yyyy-MM-dd"), ITM_CD = orgDao.ITM_CD, ITM_NM = orgDao.ITM_NM, CHNL_CD = SystemProperties.USER_VO.CHNL_CD }), System.Text.Encoding.UTF8, "application/json")))
            {
