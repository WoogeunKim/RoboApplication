...
namespace AquilaErpWpfApp3.View.M
{
    ...
    /// </summary>
    public partial class M663100 : UserControl
    {
        ...
        public M663100()
        {
            DataContext = new M663100ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "칭량현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "칭량현황");
            }
        }
