...
namespace AquilaErpWpfApp3.View.M
{
    ...
    /// </summary>
    public partial class M66540 : UserControl
    {
        ...
        public M66540()
        {
            DataContext = new M66540ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "작업지지서 발행(사출) Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "작업지지서 발행(사출)");
            }
        }
