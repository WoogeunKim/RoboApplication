...
{
    public sealed class S2232ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string title = "LOT 추적";
        ...
        public async void Refresh()
        {
            try
            {
                ...
                using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("S2232/mst", new StringContent(JsonConvert.SerializeObject(_param), System.Text.Encoding.UTF8, "application/json")))
                {
