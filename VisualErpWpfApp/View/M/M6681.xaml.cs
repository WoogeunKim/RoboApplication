...
{
    public partial class M6681 : UserControl
    {
        ...
        public M6681()
        {
            DataContext = new M6681ViewModel();
            //
            InitializeComponent();
            ...
            {
                WinUIMessageBox.Show(eLog.Message, "[에러]제품도면관리(작업표준서)", MessageBoxButton.OK, MessageBoxImage.Error);
            }
            //
