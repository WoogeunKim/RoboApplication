...
namespace AquilaErpWpfApp3.View.SAL
{
    ...
    /// </summary>
    public partial class S2228 : UserControl
    {
        ...
        public S2228()
        {
            DataContext = new S2228ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "수주현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "수주현황");
            }
        }
        ...
        //    {
        //        this.ViewGridMst.ShowLoadingPanel = false;
        //        WinUIMessageBox.Show(eLog.Message, "[에러]수주현황", MessageBoxButton.OK, MessageBoxImage.Error);
