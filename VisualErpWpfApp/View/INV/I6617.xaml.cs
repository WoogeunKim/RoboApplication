...
namespace AquilaErpWpfApp3.View.INV
{
    ...
    /// </summary>
    public partial class I6617 : UserControl
    {
        ...
        public I6617()
        {
            DataContext = new I6617ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            sb.Append("<dxe:TextEdit Text=\"" + "[일자(From) : " + Convert.ToDateTime(M_FM_DT.EditValue).ToString("yyyy-MM-dd hh:mm") + "~" + "(To) " + Convert.ToDateTime(M_TO_DT.EditValue).ToString("yyyy-MM-dd hh:mm") + "] " + "\" FontWeight=\"Bold\"  FontSize=\"8\"  />");
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "외주현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "외주현황");
            }
        }
