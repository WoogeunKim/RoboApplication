...
namespace AquilaErpWpfApp3.View.M
{
    ...
    /// </summary>
    public partial class M663300 : UserControl
    {
        ...
        public M663300()
        {
            DataContext = new M663300ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "F/Proof 위배처리 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "F/Proof 위배처리");
            }
        }
