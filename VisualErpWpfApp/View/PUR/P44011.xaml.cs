...
namespace AquilaErpWpfApp3.View.PUR
{
    ...
    /// </summary>
    public partial class P44011 : UserControl
    {
        ...
        public P44011()
        {
            DataContext = new P44011ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "수주마감 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "수주마감");
            }
        }
