...
namespace AquilaErpWpfApp3.View.SAL
{
    ...
    /// </summary>
    public partial class S2240 : UserControl
    {
        ...
        public S2240()
        {
            DataContext = new S2240ViewModel();
            InitializeComponent();
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "거래처별 판가기준표 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "거래처별 판가기준표");
            }
        }
