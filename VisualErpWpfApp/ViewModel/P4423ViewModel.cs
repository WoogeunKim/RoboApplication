...
{
    public sealed class P4423ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string _title = "구매실적관리";
        ...
        private P4423MasterDialog masterDialog;
        ...
        public async void PaymentContact()
        {
            ...
            masterDialog = new P4423MasterDialog(new PurVo() { FM_DT = SelectedMstItem.FM_DT + "01", CO_NM = SelectedMstItem.CO_NM, AREA_NM = SelectedMstItem.AREA_NM });
