...
{
    public sealed class S2240ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        public S2240ViewModel() 
        {
          ...
          public async void Refresh()
          {
              ...
              {
                  //DXSplashScreen.Close();
                  WinUIMessageBox.Show(eLog.Message, "[" + SystemProperties.PROGRAM_TITLE + "]거래처별 판가기준표", MessageBoxButton.OK, MessageBoxImage.Error, MessageBoxResult.None, MessageBoxOptions.None);
                  return;
              }
