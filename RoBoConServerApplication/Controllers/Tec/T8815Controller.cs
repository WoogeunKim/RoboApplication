...
{
    [RoutePrefix("t8815")]
    public class T8815Controller : ApiController
    {
        #region MyRegion
        //// GET api/<controller>
        ...
        {
            return Ok<IEnumerable<TecVo>>(Properties.EntityMapper.QueryForList<TecVo>("T8815SelectMstList", vo));
        }
        ...
        public async Task<IHttpActionResult> GetMstUpdate([FromBody] IEnumerable<TecVo> voList)
        {
            ...
            try
            {
                ...
                {
                    Properties.EntityMapper.QueryForObject<int?>("T8815UpdateMst", item);
                }
