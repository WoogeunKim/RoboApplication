...
namespace AquilaErpWpfApp3.View.M.Dialog
{
    ...
    /// </summary>
    public partial class M66107PurOpmzDialog : DXWindow
    {
        private ManVo orgVo;
        private string _title = "최적화 원자재 발주 요청";
        private ManVo updateDao;


        public M66107PurOpmzDialog(ManVo vo)
        {
            InitializeComponent();
        ...
        private async void Refresh()
        {
            try
            {
                ...
                this.ViewJOB_ITEMEdit.ItemsSource = await PostMstItems<ManVo>("m66107/pur/mtrl", this.orgVo);
        ...
        private async void OKButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                List<ManVo> checkList = (this.ViewJOB_ITEMEdit.ItemsSource as List<ManVo>).Where(x=>x.isCheckd == true).ToList<ManVo>();
