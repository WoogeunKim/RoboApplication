...
namespace AquilaErpWpfApp3.View.PUR
{
    ...
    /// </summary>
    public partial class P4415 : UserControl
    {
        ...
        public P4415()
        {
            DataContext = new P4415ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "발주현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "발주현황");
            }
        }
