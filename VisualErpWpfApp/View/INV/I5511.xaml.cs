...
{
    public partial class I5511 : UserControl
    {
        ...
        public I5511()
        {
            DataContext = new I5511ViewModel();
            //
            InitializeComponent();
        ...
        private void M_MST_REPORT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            if (masterDomain != null)
            {
                ...
                using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableDtl))
                {
                    ...
                    prtLink.DocumentName = "품목 입고 관리 Print";
                    ...
                    prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "품목 입고 관리");
                }
            }
        }
