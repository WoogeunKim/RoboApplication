...
{
    public sealed class M66520ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private string _title = "작업지지서 발행(충전)";

        private M66520MasterDialog masterDialog;

        //private ICommand _searchDialogCommand;

        public M66520ViewModel() 
        {
        ...
        public async void NewContact()
        {
            try
            {
                ...
                masterDialog = new M66520MasterDialog(SelectedMstItem);
