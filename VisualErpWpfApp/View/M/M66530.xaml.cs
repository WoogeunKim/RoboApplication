...
namespace AquilaErpWpfApp3.View.M
{
    ...
    /// </summary>
    public partial class M66530 : UserControl
    {
        ...
        public M66530()
        {
            DataContext = new M66530ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "작업지지서 발행(포장) Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "작업지지서 발행(포장)");
            }
        }
        ...
        private async void GridColumn_Validate(object sender, DevExpress.Xpf.Grid.GridCellValidationEventArgs e)
        {
            try
            {
                ...
                bool lotUpdDt = (e.Column.FieldName.ToString().Equals("UPD_DT") ? true : false);
                ...
                {
                    if (string.IsNullOrEmpty(masterDomain.UPD_DT + ""))
                    {
                        masterDomain.UPD_DT = "";
                    }

                    if (!masterDomain.UPD_DT.Equals((e.Value == null ? "" : e.Value)))
                    {

                        //에러 체크
                        try
                        {
                            //masterDomain.UPD_DT = Convert.ToDateTime(e.Value);
                            masterDomain.UPD_DT = e.Value;
