...
namespace AquilaErpWpfApp3.View.SAL
{
    ...
    /// </summary>
    public partial class S2247 : UserControl
    {
        ...
        public S2247()
        {
            DataContext = new S2247ViewModel();
            InitializeComponent();
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            using (PrintableControlLink prtLink = new PrintableControlLink(this.ViewTableMst))
            {
                ...
                prtLink.DocumentName = "일자별 수금현황 Print";
                ...
                prtLink.ShowPrintPreviewDialog(Application.Current.MainWindow, "일자별 수금현황");
            }
        }
        ...
        //    {
        //        this.ViewGridMst.ShowLoadingPanel = false;
        //        WinUIMessageBox.Show(eLog.Message, "[에러]일자별 수금현황", MessageBoxButton.OK, MessageBoxImage.Error);
