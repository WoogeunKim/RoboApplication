...
{
    public sealed class T91100ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string _title = "품질검사";
        ...
        public void NewContact()
        {
            if (SelectedMstItems.Count > 0)
            {
              //  string _coNm = this.SelectedMstItems[0].LOT_NO;
                ...
                detailDialog = new T91100MasterDialog(this.SelectedMstItems);
