...
{
    public sealed class T8815ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private T8815MasterDialog detailDialog;
        ...
        public void NewContact()
        {
            if (SelectedMstItems.Count > 0)
            {
              //  string _coNm = this.SelectedMstItems[0].LOT_NO;
                ...
                detailDialog = new T8815MasterDialog(this.SelectedMstItems);
