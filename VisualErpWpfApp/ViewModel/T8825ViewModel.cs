...
{
    public sealed class T8825ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        private string _title = "자재검사";
        ...
        private T8825MasterDialog detailDialog;
       ...
       public async void Refresh()
        ...
        public void NewContact()
        {
            if (SelectedMstItems.Count > 0)
            {
                ...
                detailDialog = new T8825MasterDialog(this.SelectedMstItems);
        ...
        //                    //labelDao.A10 = "원자재";//_item.ITM_GRP_NM ?? " ";
