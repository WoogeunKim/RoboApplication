...
{
    public partial class S141 : System.Windows.Controls.UserControl
    {
        ...
        public S141()
        {
            ...
            try
            {
                ...
                //this.txt_Master_Search.KeyDown += new System.Windows.Input.KeyEventHandler(txt_Master_Search_KeyDown);
        ...
        //void txt_Master_Search_KeyDown(Object sender, System.Windows.Input.KeyEventArgs e)
        //{
        //    if (e.Key == Key.Enter)
        //    {
        ...
        private void Hyperlink_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                WinUIMessageBox.Show(eLog.Message, this.title, MessageBoxButton.OK, MessageBoxImage.Error, MessageBoxResult.None, MessageBoxOptions.None);
                return;
            }
        }
        ...
        private void M_MST_PRINT_ItemClick(object sender, DevExpress.Xpf.Bars.ItemClickEventArgs e)
        {
            ...
            SystemCodeVo selVo = (SystemCodeVo)this.ConfigViewPage1Edit_Master.SelectedItem;
            if (selVo != null)
            {
