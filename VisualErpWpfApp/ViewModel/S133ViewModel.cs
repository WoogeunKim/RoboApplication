...
{
    public sealed class S133ViewModel  : ViewModelBase, INotifyPropertyChanged {
        ...
        //
        private S133MasterDialog masterDialog;
        ...
        ////
        private S133DetailDialog detailDialog;

        public S133ViewModel() 
        {
            Refresh();
        }
        ...
        {
            masterDialog = new S133MasterDialog(dao);
        ...
        public void ShowDetailDialog(SystemCodeVo dao)
        {
            ...
            //
            detailDialog = new S133DetailDialog(dao);
