...
{
    public partial class I5512MasterDialog : DXWindow
    {
        ...
        public I5512MasterDialog(InvVo Dao)
        {
            InitializeComponent();
        ...
        private async void OKButton_Click(object sender, RoutedEventArgs e)
        {
            if (ValueCheckd())
            {
                ...
                if (isEdit == false)
                {
                    ...
                    using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("i5512/mst/i", new StringContent(JsonConvert.SerializeObject(this.updateDao), System.Text.Encoding.UTF8, "application/json")))
                    {
                ...
                else
                {
                    ...
                    using (HttpResponseMessage response = await SystemProperties.PROGRAM_HTTP.PostAsync("i5512/mst/u", new StringContent(JsonConvert.SerializeObject(this.updateDao), System.Text.Encoding.UTF8, "application/json")))
                    {
                        if (response.IsSuccessStatusCode)
                        {
                            string result = await response.Content.ReadAsStringAsync();
                ...
                //    // 자동 번호 할당
                //    resultVo = invClient.I5512SelectInsrlNo(updateDao);
                //    if (!resultVo.isSuccess)
                //    {
                //        //실패
                //        WinUIMessageBox.Show("[출고 번호]" + resultVo.Message, "[에러]품목 출고 관리", MessageBoxButton.OK, MessageBoxImage.Error);
                //        return;
                //    }
                ...
                //    //{
                //    resultVo = invClient.I5512InsertMst(updateDao);
                //    if (!resultVo.isSuccess)
                //    {
                //        //실패
                //        WinUIMessageBox.Show(resultVo.Message, "[에러]품목 출고 관리", MessageBoxButton.OK, MessageBoxImage.Error);
                //        return;
                //    }
                //    //성공
                //    WinUIMessageBox.Show("[출고 번호 : " + updateDao.INSRL_NO + "] 완료 되었습니다", "[추가]품목 출고 관리", MessageBoxButton.OK, MessageBoxImage.Information);
                //    //}
                //}
                //else
                //{
                //    updateDao = getDomain();
                //    resultVo = invClient.I5512UpdateMst(updateDao);
                //    if (!resultVo.isSuccess)
                //    {
                //        //실패
                //        WinUIMessageBox.Show(resultVo.Message, "[에러]품목 출고 관리", MessageBoxButton.OK, MessageBoxImage.Error);
                ...
                //    }
                //    //성공
                //    WinUIMessageBox.Show("완료 되었습니다", "[수정]품목 출고 관리", MessageBoxButton.OK, MessageBoxImage.Information);
