...
{
    [RoutePrefix("m7711")]
    public class M7711Controller : ApiController
    {
        #region MyRegion
        //// GET api/<controller>
        ...
        public async Task<IHttpActionResult> GetMstSelect([FromBody]ManVo vo)
        {
            try
            {
                return Ok<IEnumerable<ManVo>>(Properties.EntityMapper.QueryForList<ManVo>("M7711SelectMst", vo));
            }
            catch (System.Exception eLog)
            {
                return Ok<string>(eLog.Message);
        ...
        public async Task<IHttpActionResult> GetDtlSelect([FromBody] ManVo vo)
        {
            try
            {
                return Ok<IEnumerable<ManVo>>(Properties.EntityMapper.QueryForList<ManVo>("M7711SelectDtl", vo));
            }
            catch (System.Exception eLog)
            {
                return Ok<string>(eLog.Message);
