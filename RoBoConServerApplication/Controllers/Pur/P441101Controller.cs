...
{
    [RoutePrefix("p441101")]
    public class P441101Controller : ApiController
    {
        #region MyRegion
        //// GET api/<controller>
        ...
        {
            return Ok<IEnumerable<PurVo>>(Properties.EntityMapper.QueryForList<PurVo>("P441101SelectMstList", vo));
        }
        ...
        {
            return Ok<IEnumerable<PurVo>>(Properties.EntityMapper.QueryForList<PurVo>("P441101SelectDtlList", vo));
        }
        ...
        public async Task<IHttpActionResult> GetDtlProc([FromBody] PurVo vo)
        {
            try
            {
                return Ok<int?>(Properties.EntityMapper.QueryForObject<int?>("ProcP441101", vo));
            }
        ...
        public async Task<IHttpActionResult> GetDtlUpdate([FromBody] PurVo vo)
        {
            try
            {
                ...
                return Ok<int>(Properties.EntityMapper.Update("P441101UpdateDtl", vo));
            }
            catch (System.Exception eLog)
            {
                return Ok<string>(eLog.Message);
        ...
        public async Task<IHttpActionResult> GetMemoUpdate([FromBody] PurVo vo)
        {
            try
            {
                ...
                Properties.EntityMapper.Delete("P441101DeleteMemo", vo);
                Properties.EntityMapper.Insert("P441101InsertMemo", vo);
        ...
        {
            return Ok<IEnumerable<PurVo>>(Properties.EntityMapper.QueryForList<PurVo>("P441101SelectMargeList", vo));
        }
        ...
        public async Task<IHttpActionResult> GetMargeInsert([FromBody] IList<PurVo> voList)
        {
            try
            {
                ...
                foreach (string _coCd in _coCdList)
                {
                    ...
                    _tmpMst.PUR_ORD_NO = Properties.EntityMapper.QueryForObject<string>("P441103SelectPurOrdNo", _tmpMst);
                    Properties.EntityMapper.Update("P441103UpdatePurOrdNo", _tmpMst);
                    //
                    Properties.EntityMapper.Insert("P441103InsertMst", _tmpMst);
                    ...
                    foreach (PurVo _item in _dtlList)
                    {
                        ...
                        Properties.EntityMapper.Insert("P441103InsertDtl", _item);
