...
{
    public sealed class T8813ViewModel : ViewModelBase, INotifyPropertyChanged
    {
        ...
        private T8813MasterDialog masterDialog;
        private T8813DetailDialog detailDialog;
       ...
       public async void Refresh()
        ...
        public void NewContact()
        {
            if (SelectedMstItems.Count > 0)
            {
                ...
                masterDialog = new T8813MasterDialog(this.SelectedMstItems);
                masterDialog.Title = this._title + " - [ 총 : " + SelectedMstItems.Count + " ]";
        ...
        //                    labelDao.A03 = _item.ITM_QTY;
        //                    labelDao.A16 = _item.BOX_QTY;
        //                    labelDao.A04 = " ";//_item.LOC_NM + " / " + _item.N1ST_LOC_NM;
        //                    labelDao.A05 = _item.CO_NM ?? " ";
        //                    labelDao.A06 = _item.CO_MAKE_NO ?? " ";
        //                    labelDao.A07 = _item.INSP_DT ?? " ";
        //                    labelDao.A08 = _item.INSP_NO ?? " ";
        //                    labelDao.A09 = _item.ITM_RMK ?? " ";
        //                    labelDao.A10 = "부자재";//_item.ITM_GRP_NM ?? " ";
        //                    labelDao.A11 = _item.MTRL_MAKE_DT ?? " ";
        //                    labelDao.A12 = _item.MTRL_EXP_DT ?? " ";
        ...
        //                    labelDao.A15 = _item.ITM_SZ_NM ?? " ";

        //                    //부자재 출력
        //                    _bar.B_Godex(labelDao, Convert.ToInt16(M_PRINT_CNT));
        //                }
        ...
        public async void BarPrint()
        {
            try
            {
                ...
                // FM_DT = (StartDt).ToString("yyyy-MM-dd"), TO_DT = (EndDt).ToString("yyyy-MM-dd")
                detailDialog = new T8813DetailDialog();

                //날짜 조회
                detailDialog.text_M_FM_DT.Text = (StartDt).ToString("yyyy-MM-dd");
                detailDialog.text_M_TO_DT.Text = (EndDt).ToString("yyyy-MM-dd");
                detailDialog.Refresh();
                //

                detailDialog.Title = this._title + " - [ 바코드(전체) ]";
                ...
                //    //{
                //    T8813BarCodeReport BarCodeReport = new T8813BarCodeReport(SelectedMstItems);
