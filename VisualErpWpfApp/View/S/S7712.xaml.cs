...
{
    public partial class S7712 : UserControl
    {
        //private CustomerDialog customersDialog;

        public S7712()
        {
            DataContext = new S7712ViewModel();
            //
            InitializeComponent();
        ...
        //      {
        //          this.ViewGridMst.ShowLoadingPanel = false;
        //          WinUIMessageBox.Show(eLog.Message, "[에러]공지 사항 관리", MessageBoxButton.OK, MessageBoxImage.Error);
